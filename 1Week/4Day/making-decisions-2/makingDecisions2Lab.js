...
// for(let i = 0; i < 5; i++) {
//   console.log(family)
// } ------original thought...printed out all 5 names 5x

for (let i = 0; i < family.length; i++) {
  console.log(family[i])
}

// still prints out all 5 names 5x...but Jet's doesn't
...
//   someNum = myFavoriteNumbers[6]
// }   -----------else if for multiple checks....this is only 2 options
